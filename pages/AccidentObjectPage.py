...
class PlotCanvas(FigureCanvas):
    ...
    def plot(self, times, object_distribution):
        self.axes.clear()
        for object, data in object_distribution.items():
            self.axes.plot(times, data, label=object)
...
class AccidentObjectPage(QWidget):
    ...
    def show_accident_counts(self):
       ...
       # 그래프 데이터 준비
        plot_times = hours
        plot_data = {object: [] for object in objects}
